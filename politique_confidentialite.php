...
<section class="container">
    ...
    <h3 class="article">ARTICLE 1 : Définitions </h3>
    ...
    <h3 class="article">ARTICLE 2 : Responsable du traitement </h3>
        <p>Le responsable du traitement des données personnelles visées aux présentes est la société F@stochePC11, dont le siège est situé 10 rue des caves 11120 MAILHAC, France - SIRET 813 244 944 00019 - APE 6209z.</p>

    <h3 class="article">ARTICLE 3 : Données collectées</h3>
        <h5>Nature des données collectées :</h5>
        ...
        <h5>Procédures donnant lieu à la collecte de données personnelles :</h5>
        ...
        <h5>L'objectif nécessitant la collecte et le traitement de vos données personnelles peut être :</h5>
    ...
    <h3 class="article">ARTICLE 4 : Destinataires des données</h3>
    ...
    <h3 class="article">ARTICLE 5 : Droits</h3>
        ...
        <p>Vous pouvez, en cas de contestation, former une réclamation auprès de la CNIL dont les coordonnées figurent à l’adresse internet <a id="lienCNIL" href="https://www.cnil.fr">https://www.cnil.fr</a></p>

    <h3 class="article">ARTICLE 6 : Cookies</h3>
        <p>Le site fastochepc11 utilise des cookies qui ont pour finalité de faciliter la navigation sur le site.</p>
            <h5>Type de cookies mis en place :</h5>
    ...
    <h3 class="article">ARTICLE 7 : Sécurité</h3>
    ...
    <h3 class="article">ARTICLE 8 : Durée de conservation des données</h3>
    ...
    <h3 class="article">ARTICLE 9 : Information en cas de vol de données</h3>
    ...
    <h3 class="article">ARTICLE 10 : Modification de notre politique de confidentialité</h3>
